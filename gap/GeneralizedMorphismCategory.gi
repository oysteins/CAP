...
InstallGlobalFunction( INSTALL_FUNCTIONS_FOR_GENERALIZED_MORPHISM_CATEGORY,
  ...
  function( category )
    ...
    category!.PROPAGATE_FILTERS_FROM_CATEGORY_TO_OBJECTS := MakeImmutable( GENERALIZED_MORPHISM_CATEGORY_CELL_PROPAGATION_LIST );
    
    category!.PROPAGATE_FILTERS_FROM_CATEGORY_TO_MORPHISM := MakeImmutable( GENERALIZED_MORPHISM_CATEGORY_CELL_PROPAGATION_LIST );
